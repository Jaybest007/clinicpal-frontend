...
export const Laboratory = () => {
  ...
  // Removed unused orderPage state
  const { user } = useAuth();
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-100">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-8 py-6 space-y-6">
        {/* Header and controls */}
        <div className="sticky top-0 z-20 bg-white/90 backdrop-blur border-b border-slate-200 flex flex-col md:flex-row items-start md:items-center justify-between px-4 py-3 rounded-t-xl shadow-sm">
          <h1 className="text-lg md:text-xl font-semibold text-blue-900">Laboratory Orders</h1>
            ...
            <div className="flex flex-row gap-2 w-full sm:w-auto">
              ...
              {loading ? (
                              ...
                              <>
                                <FiRefreshCcw className="inline mr-2 mb-1" />
                                Refresh
                              </>
                            )}
              </button>
